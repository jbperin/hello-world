...
%JDK_PATH%\bin\javac -Xbootclasspath/a:%JDK_PATH%\jre\rt.jar -source 1.7 -target 1.7 -d obj -classpath "libs\mqtt-client-0.4.0.jar;libs\gson-2.8.5.jar" src\com\jibe\itfmqtt\*.java src\com\jibe\lomodel\*.java
cd obj
