            ...
            ; else:
              ...
              lda tmp0 : and #BIT_3: .(:beq skip: jmp lbl_274: skip:.):
                ...
                lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_275: skip:.):
                  ...
                  lda tmp7: ora #BIT_1: sta tmp7
                  ; if (a0 == 0):
                  lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_276: skip:.):
                    ; if (a2 == 0):
                    lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_277: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_277:
            ...
            lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_677: skip:.):
              ...
              lda tmp0 : and #BIT_5: .(:beq skip: jmp lbl_678: skip:.):
                ...
                lda tmp0 : and #BIT_3: .(:beq skip: jmp lbl_679: skip:.):
                  ...
                  lda tmp7: ora #BIT_4: sta tmp7
                  ; if (a0 == 0):
                  lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_680: skip:.):
                    ; if (a1 == 0):
                    lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_681: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_681:
            ...
            lda tmp0 : and #BIT_5: .(:beq skip: jmp lbl_704: skip:.):
              ...
              lda tmp0 : and #BIT_3: .(:beq skip: jmp lbl_705: skip:.):
                ...
                lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_706: skip:.):
                  ...
                  lda tmp7: ora #BIT_1: sta tmp7
                  ; if (a1 == 0):
                  lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_707: skip:.):
                    ; if (a0 == 0):
                    lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_708: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_708:
...
lbl_723:
                ; else:
                  ; if (a0 == 0):
                  lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_726: skip:.):
                    ; if (a1 == 0):
                    lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_727: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_727:
...
lbl_737:
                ; else:
                  ; if (a0 == 0):
                  lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_740: skip:.):
                    ; if (a1 == 0):
                    lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_741: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_741:
...
lbl_774:
              ; else:
                ...
                lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_782: skip:.):
                  ...
                  lda tmp7: ora #BIT_3: sta tmp7
                  ; if (a1 == 0):
                  lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_783: skip:.):
                    ; if (a0 == 0):
                    lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_784: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_784:
...
lbl_800:
                ; else:
                  ; if (a1 == 0):
                  lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_801: skip:.):
                    ; if (a0 == 0):
                    lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_802: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_802:
            ...
            lda tmp0 : and #BIT_4: .(:beq skip: jmp lbl_833: skip:.):
              ...
              lda tmp0 : and #BIT_3: .(:beq skip: jmp lbl_834: skip:.):
                ...
                lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_835: skip:.):
                  ...
                  lda tmp7: ora #BIT_1: sta tmp7
                  ; if (a1 == 0):
                  lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_836: skip:.):
                    ; if (a0 == 0):
                    lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_837: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_837:
...
lbl_843:
                ; else:
                  ; if (a0 == 0):
                  lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_844: skip:.):
                    ; if (a1 == 0):
                    lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_845: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_845:
            ...
            lda tmp0 : and #BIT_4: .(:beq skip: jmp lbl_915: skip:.):
              ...
              lda tmp0 : and #BIT_3: .(:beq skip: jmp lbl_916: skip:.):
                ...
                lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_917: skip:.):
                  ...
                  lda tmp7: ora #BIT_1: sta tmp7
                  ; if (a1 == 0):
                  lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_918: skip:.):
                    ; if (a0 == 0):
                    lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_919: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_919:
...
lbl_925:
                ; else:
                  ; if (a0 == 0):
                  lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_926: skip:.):
                    ; if (a1 == 0):
                    lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_927: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_927:
...
lbl_928:
              ; else:
                ...
                lda tmp7: ora #BIT_1: sta tmp7
                ; if (a2 == 0):
                lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_932: skip:.):
                  ; if (a1 == 0):
                  lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_933: skip:.):
                    ; r0 = 1
                    lda tmp7: ora #BIT_0: sta tmp7
                  jmp _unefonctionDone
lbl_933:
          ...
          ; else:
            ...
            lda tmp0 : and #BIT_4: .(:beq skip: jmp lbl_934: skip:.):
              ...
              lda tmp0 : and #BIT_3: .(:beq skip: jmp lbl_935: skip:.):
                ...
                lda tmp7: ora #BIT_2: sta tmp7
                ; if (a1 == 0):
                lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_936: skip:.):
                  ; if (a2 == 0):
                  lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_937: skip:.):
                    ; r0 = 1
                    lda tmp7: ora #BIT_0: sta tmp7
                  jmp _unefonctionDone
lbl_937:
...
lbl_952:
                ; else:
                  ; if (a0 == 0):
                  lda tmp0 : and #BIT_0: .(:beq skip: jmp lbl_953: skip:.):
                    ; if (a1 == 0):
                    lda tmp0 : and #BIT_1: .(:beq skip: jmp lbl_954: skip:.):
                      ; r0 = 1
                      lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_954:
