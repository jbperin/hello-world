...
lbl_50:
                  ; else:
                    ...
                    lda tmp0: and #BIT_2+BIT_0+BIT_1: .(:beq skip: jmp lbl_55: skip:.)
                          ; r0 = 1
                          lda tmp7: ora #BIT_0: sta tmp7
                      jmp _unefonctionDone
lbl_56:
...
lbl_116:
                ; else:
                  ...
                  lda tmp0: and #BIT_3+BIT_0+BIT_2+BIT_1: .(:beq skip: jmp lbl_118: skip:.)
                          ; r0 = 1
                          lda tmp7: ora #BIT_0: sta tmp7
                      jmp _unefonctionDone
lbl_120:
...
lbl_129:
                  ; else:
                    ; if (a0 == 0) and (a2 == 0) and (a1 == 0):
                    lda tmp0: and #BIT_0+BIT_2+BIT_1: .(:beq skip: jmp lbl_130: skip:.)
                          ; r0 = 1
                          lda tmp7: ora #BIT_0: sta tmp7
                      jmp _unefonctionDone
lbl_131:
...
lbl_125:
          ; else:
            ...
            lda tmp0 : and #BIT_7: .(:beq skip: jmp lbl_172: skip:.):
              ; r1 = 1
              lda tmp7: ora #BIT_1: sta tmp7
              ; if (a4 == 0) and (a3 == 0) and (a5 == 0):
              lda tmp0: and #BIT_4+BIT_3+BIT_5: .(:beq skip: jmp lbl_173: skip:.)
                    ; r0 = 1
                    lda tmp7: ora #BIT_0: sta tmp7
                jmp _unefonctionDone
lbl_174:
...
lbl_180:
                    ; else:
                      ; if (a0 == 0) and (a1 == 0):
                      lda tmp0: and #BIT_0+BIT_1: .(:beq skip: jmp lbl_182: skip:.)
                          ; r0 = 1
                          lda tmp7: ora #BIT_0: sta tmp7
                      jmp _unefonctionDone
lbl_182:
...
lbl_200:
                  ; else:
                    ; if (a0 == 0) and (a2 == 0) and (a1 == 0):
                    lda tmp0: and #BIT_0+BIT_2+BIT_1: .(:beq skip: jmp lbl_202: skip:.)
                          ; r0 = 1
                          lda tmp7: ora #BIT_0: sta tmp7
                      jmp _unefonctionDone
lbl_203:
...
lbl_223:
                    ; else:
                      ; if (a1 == 0) and (a0 == 0):
                      lda tmp0: and #BIT_1+BIT_0: .(:beq skip: jmp lbl_225: skip:.)
                          ; r0 = 1
                          lda tmp7: ora #BIT_0: sta tmp7
                      jmp _unefonctionDone
lbl_225:
...
lbl_232:
                  ; else:
                    ; if (a0 == 0) and (a2 == 0) and (a1 == 0):
                    lda tmp0: and #BIT_0+BIT_2+BIT_1: .(:beq skip: jmp lbl_234: skip:.)
                          ; r0 = 1
                          lda tmp7: ora #BIT_0: sta tmp7
                      jmp _unefonctionDone
lbl_235:
...
lbl_284:
              ; else:
                ; if (a1 == 0) and (a5 == 0) and (a3 == 0) and (a2 == 0):
                lda tmp0: and #BIT_1+BIT_5+BIT_3+BIT_2: .(:beq skip: jmp lbl_296: skip:.)
                        ; r0 = 1
                        lda tmp7: ora #BIT_0: sta tmp7
                    jmp _unefonctionDone
lbl_298:
