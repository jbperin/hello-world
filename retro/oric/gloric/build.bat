...
%OSDK%\BIN\link65.exe  -d %OSDK%\lib/ -o %OSDK%\TMP\linked.s  -f -q  %OSDK%\TMP\main glOric.s atan2.s div.s root.s square.s norm.s print.s line.s kernel.s screen.s line8.s display.s buffer.s filler.s hseg8.s fill8.s
