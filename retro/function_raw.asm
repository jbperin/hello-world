...
lbl_6:
            ; else:
              ...
              lda tmp0 : and #BIT_0: .(:bne skip: jmp lbl_12: skip:.):
                ; if (a1 != 0):
                lda tmp0 : and #BIT_1: .(:bne skip: jmp lbl_13: skip:.):
                  ; r0 = 1
                  lda tmp7: ora #BIT_0: sta tmp7
                jmp _unefonctionDone
lbl_13:
        ...
        ; else:
          ...
          lda tmp0 : and #BIT_3: .(:bne skip: jmp lbl_21: skip:.):
            ...
            lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_22: skip:.):
              ; if (a1 != 0):
              lda tmp0 : and #BIT_1: .(:bne skip: jmp lbl_23: skip:.):
                ; if (a0 != 0):
                lda tmp0 : and #BIT_0: .(:bne skip: jmp lbl_24: skip:.):
                  ; r0 = 1
                  lda tmp7: ora #BIT_0: sta tmp7
                jmp _unefonctionDone
lbl_24:
...
lbl_27:
        ; else:
          ...
          lda tmp7: ora #BIT_1: sta tmp7
          ; if (a3 != 0):
          lda tmp0 : and #BIT_3: .(:bne skip: jmp lbl_34: skip:.):
            ; if (a2 != 0):
            lda tmp0 : and #BIT_2: .(:bne skip: jmp lbl_35: skip:.):
              ; if (a0 != 0):
              lda tmp0 : and #BIT_0: .(:bne skip: jmp lbl_36: skip:.):
                ; if (a1 != 0):
                lda tmp0 : and #BIT_1: .(:bne skip: jmp lbl_37: skip:.):
                  ; r0 = 1
                  lda tmp7: ora #BIT_0: sta tmp7
                jmp _unefonctionDone
lbl_37:
        ...
        lda tmp0 : and #BIT_5: .(:beq skip: jmp lbl_99: skip:.):
          ...
          lda tmp0 : and #BIT_2: .(:beq skip: jmp lbl_100: skip:.):
            ...
            lda tmp0 : and #BIT_3: .(:beq skip: jmp lbl_101: skip:.):
              ; if (a1 != 0):
              lda tmp0 : and #BIT_1: .(:bne skip: jmp lbl_102: skip:.):
                ; if (a0 != 0):
